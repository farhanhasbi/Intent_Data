...
public class KonvertMeter extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.konvert_to_meter);
    ...
    public void onClick(View view) {
        ...
        double hasil = Double.parseDouble(satuan.getText().toString())*0.001;
